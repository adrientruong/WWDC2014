...
- (void)setItemSize:(CGSize)itemSize
{
    ...
    self.minimumLineSpacing = -(itemSize.width / 3);
    self.headerReferenceSize = CGSizeMake(itemSize.width / 2 + 5, 0);
    self.footerReferenceSize = CGSizeMake(itemSize.width / 2 + 5, 0);
}
